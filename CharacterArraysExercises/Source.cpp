...
int main()
{
	...
	{
		//a) Username needs to contain 'usr' within it
		{

		}
		//b) password as 'Pa55w0rd'
		{
	...
	{
		string input;
		cout << "Please enter a word that could be a palindrome:\n\n";
		cin >> input;
